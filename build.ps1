...
$chunks = @{
    'core' = @{
        files = @('icons.js', 'icons-pro.js', 'nav-enhancer.js', 'topbar-enhancer.js', 'charts.js', 'holidays.js', 'core.js', 'bus.js', 'store.js', 'vault.js', 'router.js', 'performance-monitor.js', 'theme-switcher.js')
